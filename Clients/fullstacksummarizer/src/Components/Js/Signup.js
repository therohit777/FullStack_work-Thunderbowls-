    ...
    <div className='loginpart'>
      <div className="Login">
        ...
        <div className="container1">
          ...
          <input type="text" className="textinput1" placeholder="Username" ref={username}/>
          <input type="email" className="textinput1" placeholder="Email ID" ref={mailtxt2}/>
          <input type="password" className="textinput1"placeholder="Password" ref={pass1}/>
          <input type="password" className="textinput1"placeholder="Confirm Password" ref={pass2}/>
          <p className="beta1">{signmessage}</p>
          <button className="signbtn" onClick={()=>signaction(username,mailtxt2,pass1,pass2)}>Signup</button>
        </div>
      </div>
    </div>
  );
